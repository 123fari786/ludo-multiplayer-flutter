...
import 'package:ludo_game/state/game_state.dart';
...
class YellowGridComponent extends PositionComponent {
  ...
  YellowGridComponent({required double size, this.showId = false})
              ...
              children: [
                ...
                if (col == 5 && row == 1)
                  ArrowIconComponent(
                    ...
                    fillColor: GameState()
                        .yellow, // Set the fill color for the triangle
                  ),
